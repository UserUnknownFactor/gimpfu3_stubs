...
class Bytes(__gi.Boxed):
    ...
    def get_size(self): ...
    def hash(self): ...
    def new(self, data: Incomplete | None = ...) -> Bytes: ...
    def new_from_bytes(self, offset, length) -> Bytes: ...
...
class Checksum(__gi.Boxed):
    ...
    def free(self) -> None: ...
    def get_string(self): ...
    def new(self, checksum_type) -> Checksum: ...
    def reset(self) -> None: ...
...
class Date(__gi.Boxed):
    ...
    def new(self) -> Date: ...
    def new_dmy(self, day, month, year) -> Date: ...
    def new_julian(self, julian_day) -> Date: ...
...
class DateTime(__gi.Boxed):
    ...
    def new(self, tz, year, month, day, hour, minute, seconds) -> DateTime: ...
    def new_from_iso8601(self, text, default_tz: Incomplete | None = ...) -> DateTime: ...
    def new_from_timeval_local(self, tv) -> DateTime: ...
    def new_from_timeval_utc(self, tv) -> DateTime: ...
    def new_from_unix_local(self, t) -> DateTime: ...
    def new_from_unix_utc(self, t) -> DateTime: ...
    def new_local(self, year, month, day, hour, minute, seconds) -> DateTime: ...
    def new_now(self, tz) -> DateTime: ...
    def new_now_local(self) -> DateTime: ...
    def new_now_utc(self) -> DateTime: ...
    def new_utc(self, year, month, day, hour, minute, seconds) -> DateTime: ...
    def ref(self) -> None: ...
...
class MappedFile(__gi.Boxed):
    ...
    def get_length(self): ...
    def new(self, filename, writable) -> MappedFile: ...
...
class MarkupParseContext(__gi.Boxed):
    ...
    def new(self, parser, flags, user_data, user_data_dnotify) -> MarkupParseContext: ...
...
class PatternSpec(__gi.Boxed):
    ...
    def new(self, pattern) -> PatternSpec: ...
    def __delattr__(self, *args, **kwargs) -> None: ...
    def __dir__(self, *args, **kwargs) -> None: ...
    def __eq__(self, *args, **kwargs): ...
    def __format__(self, *args, **kwargs) -> None: ...
...
class Regex(__gi.Boxed):
    ...
    def new(self, pattern, compile_options, match_options) -> Regex: ...
    def ref(self) -> None: ...
...
class String(__gi.Boxed):
    ...
    def new(self, init: Incomplete | None = ...) -> String: ...
...
class Thread(__gi.Boxed):
    ...
    def join(self) -> None: ...
    def new(self, name, func, data: Incomplete | None = ...) -> Thread: ...
    def ref(self) -> None: ...
    def self(self) -> None: ...
...
class TimeZone(__gi.Boxed):
    ...
    def new(self, identifier: Incomplete | None = ...) -> TimeZone: ...
...
class VariantBuilder(__gi.Boxed):
    ...
    def copy(self, *args, **kwargs) -> None: ...
    def end(self) -> None: ...
    def new(self, type) -> VariantBuilder: ...
...
class VariantDict(__gi.Boxed):
    ...
    def lookup_value(self, key, expected_type: Incomplete | None = ...) -> None: ...
    def new(self, from_asv: Incomplete | None = ...) -> VariantDict: ...
    def ref(self) -> None: ...
    def remove(self, key): ...
    def unref(self) -> None: ...
    def __delattr__(self, *args, **kwargs) -> None: ...
...
class VariantType(__gi.Boxed):
    ...
    def is_variant(self): ...
    def key(self) -> None: ...
    def new(self, type_string) -> VariantType: ...
